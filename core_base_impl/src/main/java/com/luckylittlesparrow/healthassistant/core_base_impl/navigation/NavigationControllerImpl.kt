package com.luckylittlesparrow.healthassistant.core_base_impl.navigation
...
import com.luckylittlesparrow.healthassistant.core_base_impl.R
import java.util.*
...
//    private var lastFragmentBeforeOnBackPressed: Fragment? = null
    ...
    private fun setOnNavigationItemSelectedListener(bottomNavigationView: BottomNavigationView, item: MenuItem): Boolean {
